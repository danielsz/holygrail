...
The ~boot-system~ task allow you to automate all of the above. 
...
Let’s demonstrate how liberating the experience can be when developing a web app with ~boot-system~. 
